...
public class MainActivity extends BridgeActivity implements IUnityAdsInitializationListener {
    ...
    private static final String UNITY_GAME_ID = "5875350"; // replace with real
...
private static final int VERSION_CODE = 1034;
...
System.out.println("registering class");
        registerPlugin(StartioHelper.class);  // ✅ This registers your custom plugin
...
public void onInitializationComplete() {
    ...
    //             // Reward the user
    //             Log.d("UnityAds", "Reward user here");
    //             // Optionally: notify JS with webView.evaluateJavascript(...)
    //         }
    //     }
    // };
        @Override
        public void onUnityAdsShowComplete(String placementId, UnityAds.UnityAdsShowCompletionState state) {
            ...
            if (state == UnityAds.UnityAdsShowCompletionState.COMPLETED) {
                ...
                // 👇 Notify JavaScript that the ad was seen successfully
                String jsCode = "window.dispatchEvent(new CustomEvent('AdRewarded', { detail: { placementId: '" + placementId + "' } }));";

                if (bridge != null && bridge.getWebView() != null) {
                    runOnUiThread(() -> bridge.getWebView().evaluateJavascript(jsCode, null));
                }
            }
        }
