...
export default function SettingsPage({ ForAllSounfds, setForAllSounds, setismute, isnotmute, mode, setMode, messagesRef,setCurrentUser}) {
    ...
    <div className="profile-section">
      <div className="profile-avatars">
        <div className="avatar">
          <div className="avatar-placeholder" onClick={() => history.push('/Profile')}>👤</div>
        </div>
        <div className="avatar">
      ...
      <div className="action-buttons">
        <button className="action-btn"       onClick={() => history.push("/AdminChat")}>
     ...
     <div className="flex items-center justify-between bg-gray-800 rounded-2xl p-3 mt-3 shadow-md w-full">
       ...
       <div className="flex items-center space-x-2 flex-shrink-0">
         ...
         <button
           ...
           onClick={async () => {
             localStorage.removeItem('ForAllSoundNotification');
             await Preferences.remove({ key: 'ForAllSoundNotification' });
